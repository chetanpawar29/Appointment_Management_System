...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Pending Appointments</h3>
		...
		{%>
			...
			{%>
				<tr>
					...
					<td><a href="e_6_approveAppo.jsp?apoId=<%=rs.getInt(1)%>"><button class="btn btn-default" style="background-color: green">Approve</button></a></td>
					<td><a href="e_7_DisapproveAppo.jsp?apoId=<%=rs.getInt(1)%>"><button class="btn btn-default" style="background-color: red">Disapprove</button></a></td>
				</tr>
			<% }
		}
		catch(Exception e)
