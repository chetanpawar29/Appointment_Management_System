...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Today's Appointments</h3>
...
<table>
		...
		{%>
			...
			Date todaysDate = Date.valueOf(curDate);
		
			Connection con = DBConnection.dbCon();
			PreparedStatement ps = con.prepareStatement("select * from appointment where (empId=? and apoDate=?) and status=?");	
			ps.setInt(1, empId);
