...
<body class="cbp-spmenu-push">
			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form action="e_5_changePassword.jsp" method="post"> 
	...
	try
	{
		 ...
		 if(newPass != null)
		 {
			 ...
			 PreparedStatement ps = con.prepareStatement("Update employee set empPass=? where empPass=?");	 
		 	 ...
		 	 if(i>0)
		 	 {
		 		...
		 		response.sendRedirect("e_5_changePassword.jsp");
		 	 }
		 }
	}
	catch(Exception e)
