...
<body class="cbp-spmenu-push">
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="u_1_viewEmployee.jsp"><i class="fa fa-check-square-o nav_icon"></i>View Employees</a>
						</li>
						<li>
							<a href="u_2_bookAppointment.jsp"><i class="fa fa-check-square-o nav_icon"></i>Book Appointment</a>
						</li>
						<li>
							<a href="u_3_viewStatusofdAppo.jsp"><i class="fa fa-check-square-o nav_icon"></i>View Status of Appointment</a>
						</li>
						<li>
							<a href="u_4_viewTodayApprovedAppo.jsp"><i class="fa fa-check-square-o nav_icon"></i>View Today's Appointments</a>
						</li>
						<li>
						...
						<div class="form-body">
							<form action="u_6_bookAppointment.jsp" method="post"> 
								<div class="form-group"> 
									...
									<input type="text" name="empId" class="form-control" id="exampleInputEmail1" readonly="readonly" value="<%=Integer.parseInt(request.getParameter("empId"))%>"> 
	...
	%>
		<div class="footer">
		   <p>&copy; 2024 Unity Bank. All Rights Reserved | Design by <a href="https://www.linkedin.com/in/chetan-pawar-a023a2240">Chetan Pawar</a></p>
		</div>
        <!--//footer-->
	</div>
	<!-- Classie -->
